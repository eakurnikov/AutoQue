...
class PackageVerifierImpl @Inject constructor(
    ...
    private val gplayInstallerPackageNames = listOf(
        "com.android.vending",
        "com.google.android.feedback"
    )

    private val samsungInstallerPackageNames = listOf(
    ...
    private fun isInstallerKnown(clientPackageName: String): Boolean {
        val installerPackageName: String = getInstallerPackageName(clientPackageName) ?: return false
        return gplayInstallerPackageNames.contains(installerPackageName) ||
                samsungInstallerPackageNames.contains(installerPackageName)
    }
        ...
        return try {
            with(context.packageManager) {
                ...
                val clientAppInfo: PackageInfo =
                    getPackageInfo(appInfo.packageName, PackageManager.GET_SIGNATURES) ?: return@with false
